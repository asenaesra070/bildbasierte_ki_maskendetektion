...
from model.resnet50_transfer import get_resnet50_model          # ResNet50 Modell mit Transfer Learning
...
# Nur die ersten 15 Bilder verwenden
...
save_dir = "predicted_samples"
os.makedirs(save_dir, exist_ok=True)  # Ordner erstellen, falls nicht vorhanden

# Bilder speichern mit einfachen Namen (z.B. sample_1.png)
