...
# ------------------- Hyperparameters -------------------------------------------
learning_rate = 0.001
# Änderung: Ich balanciere den unausgeglichenen Datensatz, sodass der Rückruf nicht immer 1 zurückgibt
...
# Metrik-Listen fürTrainings- und Validierung speichern
metrics = {
...
torch.save(metrics, "results/metrics_lists.pt")
print("Trainings und Validierung metriken gespeichert: results/metrics_lists.pt")